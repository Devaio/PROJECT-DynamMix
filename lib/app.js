...
(function() {
  var FacebookStrategy, LastFmNode, LocalStrategy, app, express, findById, findByUsername, flash, getRelatedArtists, http, lastfm, passport, path, trackStream, users;
  ...
  trackStream = lastfm.stream("devaio");

  trackStream.on("lastPlayed", function(track) {
    return console.log("Last played: " + track.name + " by " + track.artist["#text"]);
  });

  trackStream.on("nowPlaying", function(track) {
    return console.log("Now playing: " + track.name + " by " + track.artist["#text"]);
  });
